...
# Finnhub for quote & earnings
FINNHUB_API_KEY      = os.getenv("FINNHUB_API_KEY")
FINNHUB_SECRET       = os.getenv("FINNHUB_SECRET")
FINNHUB_QUOTE_URL    = "https://finnhub.io/api/v1/quote"
FINNHUB_EARNINGS_URL = "https://finnhub.io/api/v1/calendar/earnings"

# Twelve Data for dividends & quotes & market breadth
...
def get_earnings(ticker: str):
    """
    Earnings: return 200 with nextEarningsDate=None when not found,
    instead of raising 404, so the UI can show 'N/A'.
    """
    symbol = ticker.upper()
    ...
    try:
        ...
        # On other errors, return a soft 200 with no data
...
def get_dividends(ticker: str):
    """
    Dividends: return 200 with available=False if none or blocked by plan,
    so the UI can show 'N/A' instead of erroring.
    """
    symbol = ticker.upper()
    try:
        r = requests.get(
        ...
        # Plan/blocked message shape: {"status":"error","message":"..."}
